...
class StartAll {
    ...
    ServiceDescriptor[] getServiceDescriptors() {
        ...
        def descriptors = []
        def configArg = ["${configPath}/hasherMD5-prv.config"]
        def codebase = "${relativeRepoPath}/hasherMD5-${sorcerVersion}-dl.jar ${relativeRepoPath}/hasherMD5-${sorcerVersion}-ui.jar sorcer-dl-${sorcerVersion}.jar jsk-dl-${riverVersion}.jar"

        descriptors << new SorcerServiceDescriptor(codebase,
                                                   policy,
                                                   "${buildLibPath}/hasherMD5-${sorcerVersion}-prv.jar${File.pathSeparator}${buildLibPath}/hasherMD5-${sorcerVersion}-ui.jar",
